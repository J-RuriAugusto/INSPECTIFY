...
const Results = () => {
    ...
    return `
      ...
      <html>
        <head>
          ...
          <title>Typhoon Preparedness Assessment</title>
          <style>
            body { 
        ...
        <body>
          <div class="header">
            ...
            <div class="header-text">
              <h1>Typhoon Preparedness Assessment</h1>
          ...
          <div class="footer">
            <p>This assessment is generated based on your responses to the typhoon preparedness questionnaire.</p>
  ...
  const handleDownload = async () => {
    try {
      ...
      const fileName = `typhoon_results_${new Date().getTime()}.pdf`;
