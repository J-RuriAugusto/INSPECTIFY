    ...
    return `
      ...
      <html>
        <head>
          ...
          <title>${t('GENERAL_PREPAREDNESS_ASSESSMENT')}</title>
          <style>
            @page {
              margin: 0.5in;
            }
        ...
        <body>
          <div class="header">
            ...
            <div class="header-text">
              <h1>${t('GENERAL_PREPAREDNESS_ASSESSMENT')}</h1>
          ...
          <div class="footer">
            <p>${t('GENERAL_BASED_ON_YOUR_RESPONSE')}</p>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <View style={styles.content}>
            <Text style={styles.title}>{t('GENERAL_PREPAREDNESS_RESULT')}</Text>
