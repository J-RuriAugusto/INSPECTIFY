...
const Results = () => {
  ...
  const getRiskLevel = () => {
    if (numericScore <= 5) return { label: 'Not Prepared', color: '#F44336' };
    if (numericScore <= 10) return { label: 'Moderately Prepared', color: '#FFC107' };
    return { label: 'Highly Prepared', color: '#4CAF50' };
  };
